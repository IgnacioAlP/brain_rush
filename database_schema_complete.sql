-- ================================================================================
-- BRAIN RUSH - COMPLETE DATABASE SCHEMA (OPTIMIZED)
-- Script de creación completo - 19 tablas esenciales
-- ================================================================================
-- MySQL Version: 5.7+
-- Character Set: utf8mb4
-- Tablas eliminadas: roles, usuario_roles, participaciones, respuestas_estudiantes, ranking
-- ================================================================================
...
-- ================================================================================
-- 4. TABLA: cuestionario_preguntas
-- ================================================================================
...
-- ================================================================================
-- 10. TABLA: respuestas_participantes
-- ================================================================================
...
-- ================================================================================
-- 13. TABLA: recompensas_otorgadas
-- ================================================================================
...
SELECT '📊 Total de tablas: 19 (eliminadas 5 tablas no utilizadas)' as info;

-- Tablas eliminadas por no estar en uso:
-- ❌ roles - Solo endpoints API sin uso real
-- ❌ usuario_roles - Sin uso en la aplicación
-- ❌ participaciones - Reemplazada por participantes_sala
-- ❌ respuestas_estudiantes - Reemplazada por respuestas_participantes
-- ❌ ranking - Reemplazada por ranking_sala

-- Contar tablas creadas
SELECT COUNT(*) as total_tablas FROM information_schema.tables WHERE table_schema = 'brain_rush';
